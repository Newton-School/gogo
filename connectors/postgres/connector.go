...
func Open(ctx context.Context, config Config) (*Backend, error) {
	...
	backend := &Backend{pool: pool, alias: config.Alias, capabilities: db.Capabilities{"returning": true, "on_conflict": true, "transactions": true, "savepoints": true, "row_locks": true, "row_lock_of": true, "row_lock_no_key": true, "json": true, "arrays": true, "ranges": true, "window": true, "window_rows_frame": true, "window_range_frame": true, "window_frame_exclusion": true, "regex": true, "distinct_on": true, "filtered_aggregates": true, "conditional_expressions": true, "grouped_queries": true, "grouped_relation_joins": true, "transactional_ddl": true, "concurrent_indexes": true}}
